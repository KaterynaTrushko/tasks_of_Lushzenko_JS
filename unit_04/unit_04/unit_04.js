...
function f5() {
    if (document.querySelector('.i-5').checked) {
        document.querySelector('.out-5').textContent = document.querySelector('.i-5').value;
    } else {
...
function f7() {
    const str = document.querySelector('.i-7').value;
    const outPut1 = document.querySelector('.out-71');
    const outPut2 = document.querySelector('.out-72');
...
function f8() {
   ...
   document.querySelector('.out-8').append(div);
}
...
if (document.querySelector('.r-9').checked){
    document.querySelector('.out-9').textContent = document.querySelector('.r-9').value; 
} else {
...
document.querySelector('.out-10').style.backgroundColor = value;
}
...
// Task 11
// При нажатии кнопки .b-11 запускается функция f11. Функция получает цвет из .i-111 и присваивает как value 
//элементу .i-112. Т.е. после нажатия кнопки выбранный цвета в первом и втором input станут одинаковые.
