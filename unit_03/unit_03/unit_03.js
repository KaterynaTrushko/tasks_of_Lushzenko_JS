...
function f4() {
   ...
   let age = current.getFullYear() - data;
   if (age  >= 18) {
...
function f10() {
   ...
   switch (a) {
      case 6:
         document.querySelector('.out-10').textContent = '6';
         break;
      case 7:
         document.querySelector('.out-10').textContent = '7';
         break;
      case 11:
         document.querySelector('.out-10').textContent = '11';
         break;
      case 9:
         document.querySelector('.out-10').textContent = '9';
         break;
   }
}
...
function f13() {
   ...
   //потому что инпут всегда выдает тип строку
}
...
let i143 = document.querySelector('.s-143');
