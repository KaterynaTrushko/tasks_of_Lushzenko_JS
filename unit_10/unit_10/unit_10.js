...
let ar2 = ['str', 35, true, 'code', false];
...
let ar3 = ['str', 35, true, 'code', false, 5, 100, 45, 'star'];
...
let ar4 = ['str', 35, true, 'code', false, 5, 100, 45, 'star'];
...
function f6() {
    let arr = ['Kate', 'Taurus', 19, 'May'];
    let out = `${arr[0]} ${arr[1]} ${arr[2]} ${arr[3]}`;
...
// Выведите массив в .out-8. Разделитель - дефис. 
// В .out-8-1 выведите длину массива ar8.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
// Task 10
// Выведите сумму первого (индекс 1) и последнего массива 
// ar10 в блок out-10. Индекс последнего элемента массива 
// не указывайте напрямую, а вычисляйте через длину массива.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
// и четвертый (индекс 4) элемент массива ar11 и выводит его в out-11. 
// Разделитель - пробел.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
// Task 12
// Напишите функцию f12, которая меняет местами нулевой 
// и последний элемент массива ar12 и выводит его в out-12. 
...
// Task 16
// Выполните перебор массива arr16. Четные элементы добавьте 
// в массив ar16_even, нечетные в ar16_odd. Добавление в массив - 
// по индексу, а не +=!!!!!. Протестируйте задачу на повторный запуск! 
...
function f16() {
    ...
    document.querySelector('div.out-16-odd').textContent = out_odd;
    document.querySelector('div.out-16-even').textContent = out_even;
}
...
function f17() {
    ...
    document.querySelector('.out-17').textContent = ar_out.length;
}
