...
function t1() {
  ...
  request.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=1', true); //auth=DdC33D7d2C2a7&
  request.send();
...
function t2() {
  ...
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&name=Kate&action=2');
  req.send();
...
function t3() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&num1=5&num2=6&action=3');
  req.send();
  req.onreadystatechange = function () {
    if (req.readyState == 4 & req.status == 200) {
      const response = req.responseText;
...
function t4() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&num1=5&num2=6&action=4');
  req.send();
  req.onreadystatechange = function () {
    if (req.readyState == 4 & req.status == 200) {
...
function t5() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=5');
  req.send();
  req.onreadystatechange = function(){
    if(req.readyState == 4 & req.status == 200){
...
function t6() {
  let req = new XMLHttpRequest();
  req.open('GET','http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&num1=5&num2=6&action=6');
  req.send();
  req.onreadystatechange = function(){
    if(req.readyState == 4 & req.status == 200){
      let res = req.responseText;
...
function t7() {
  let req = new XMLHttpRequest();
  req.open('GET','http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=7');
  req.send();
  req.onreadystatechange = function(){
    if(req.readyState == 4 & req.status == 200){
      let res = req.responseText;
...
function t8() {
  let req = new XMLHttpRequest();
  req.open('GET','http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&year=1986&action=8');
  req.send();
  req.onreadystatechange = function(){
    if(req.readyState == 4 & req.status == 200){
      let res = req.responseText;
...
function t9() {
  let req = new XMLHttpRequest();
  req.open('GET','http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&m=1&d=1&y=1&action=9');
  req.send();
  req.onreadystatechange = function(){
    if (req.readyState == 4 & req.status == 200){
      let res = req.responseText;
...
function t10() {
  ...
  xhr.open("POST", "http://getpost.itgid.info/index2.php");
...
document.querySelector('.b-1').onclick = t10;
...
function t11() {
  let req = new XMLHttpRequest();
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&name=Kate&action=2");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
...
function t12() {
  ...
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&num1=5&num2=9&action=3");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
...
function t13() {
  ...
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&num1=5&num2=9&action=4");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
...
function t14() {
  ...
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&action=5");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
...
function t15() {
  ...
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&num1=10&num2=100&action=6");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
...
function t16() {
  ...
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&action=7");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
...
function t17() {
  ...
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&year=1986&action=8");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
...
function t18() {
  ...
  req.open("POST", "http://getpost.itgid.info/index2.php");
  req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
  req.send("auth=DdC33D7d2C2a7&m=1&d=1&y=1&action=9");
  req.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
