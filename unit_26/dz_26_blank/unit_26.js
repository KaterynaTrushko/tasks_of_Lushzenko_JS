...
function t1() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=1')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-1').textContent = date;
    })
...
function t2() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&name=Kate&action=2')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-2').textContent = date;
    })
}
...
function t3() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&num1=1&num2=2&action=3')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-3').textContent = date;
    })
}
...
function t4() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&num1=1&num2=3&action=4')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-4').textContent = date;
    })
...
function t5() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=5')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-5').textContent = date;
    })
...
function t6() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&num1=1&num2=3&action=6')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-6').textContent = date;
    })
...
function t7() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=7')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-7').textContent = date;
    })
...
function t8() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&year=1986&action=8')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-8').textContent = date;
    })
...
function t9() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&m=1&d=1&y=1&action=9')
    .then(date => date.text())
    .then(date => {
      document.querySelector('.out-9').textContent = date;
    })
...
function t11() {
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&name=Kate&action=2' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
...
function t12() {
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&num1=2&num2=4&action=3' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
...
function t13() {
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&num1=5&num2=10&action=4' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
...
function t14() {
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&action=5' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
...
function t15() {
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&num1=15&num2=18&action=6' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
...
function t16() {
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&action=7' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
...
function t17() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&year=1986&action=8' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
...
function t18() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
      ...
      body: 'auth=DdC33D7d2C2a7&m=1&d=1&y=1&action=9' // body data type must match "Content-Type" header
    })
    .then(response => response.text())
    .then(response => {
